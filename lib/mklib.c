...
/*---------------------------------------------------------------------------
 * This is mklib version unknowable for C7000 compiler  
...
const char *isa = "C7000";
const char *version = "unknowable";
int         buildmodel = 2011;
const char *c_dir_name = "C7X_C_DIR";
...
library_t LIBRARIES[] = {
    { "rts7120_le_eh.lib", { "C7120","LITTLE_ENDIAN","EXCEPTIONS","EABI_TDEH" } },
    { "rts7100_be.lib", { "C7100","BIG_ENDIAN" } },
    { "rts7100_le.lib", { "LITTLE_ENDIAN","C7100" } },
    { "rts7120_be_eh.lib", { "EABI_TDEH","EXCEPTIONS","BIG_ENDIAN","C7120" } },
    { "rts7100_be_eh.lib", { "C7100","BIG_ENDIAN","EABI_TDEH","EXCEPTIONS" } },
    { "rts7120_be.lib", { "C7120","BIG_ENDIAN" } },
    { "rts7100_le_eh.lib", { "EXCEPTIONS","EABI_TDEH","C7100","LITTLE_ENDIAN" } },
    { "rts7120_le.lib", { "LITTLE_ENDIAN","C7120" } },
};

const char *OBJ_SUBDIRS[] = { "libcxx","libcxx/ext","libcxx/include","libcxx/support/runtime","libcxx/support/ti","machine","stlport","sys","vcop","xlocale" };
